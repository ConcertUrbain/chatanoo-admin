...
aws s3 cp infra/admin.cfn.yml s3://chatanoo-deployment.eu-west-1/infra/admin/$TRAVIS_TAG.cfn.yml
aws s3 cp build/admin.zip s3://chatanoo-deployment.eu-west-1/admin/$TRAVIS_TAG.zip
